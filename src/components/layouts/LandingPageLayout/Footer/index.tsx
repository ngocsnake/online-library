...
const socials = [
  {
    key: "instagram",
    name: "Instagram",
    url: "https://www.instagram.com/dfree.book",
    icon: <InstagramFilled />,
  },
  {
    key: "facebook",
    name: "Facebook",
    url: "https://www.facebook.com/dfreebook",
    icon: <Facebook />,
  },
  {
    key: "tiktok",
    name: "Tiktok",
    url: "https://www.tiktok.com/@thuviendfreebook ",
    icon: <Tiktok />,
  },
  {
    key: "youtube",
    name: "Youtube",
    url: "https://www.youtube.com/@dfreebook4067",
    icon: <YoutubeFilled />,
  },
];
...
export const pages = [
  ...
  {
    key: "partners-communications",
    title: "Đối tác & truyền thông",
    path: "partners-communications",
  },
      ...
      <Row className={styles.footer} gutter={[32, 32]}>
        <Col xs={24} md={12} lg={10}>
          <div>
            ...
            <Typography.Text className="visible mt-3 mb-10">
              ...
              <Typography.Text className="visible">
                sách miễn phí và đặt cọc niềm tin.
              </Typography.Text>
            </Typography.Text>
        ...
        <Col xs={24} md={12} lg={4}>
          <div>
            ...
            <div className="flex flex-col gap-3">
              {supports.map((item) => (
                <Link className={styles.textHover} href={item.path}>
                  {item.title}
                </Link>
              ))}
            </div>
